 ...
 <div class="tools">
     ...
     <form action="/item/kucun/search" method="post">
    	...
    	<tr>
   		   <td>
   				大  类：
   				<select name="bid"  id="bigType" onchange="loadSmall(this);"  style="float: right;margin-top: 6px;border:0.5px solid #3186C8">
   			...
   			<td colspan="3">
   				<input type="submit" value="查询" id="searchPro"/>&nbsp;&nbsp;&nbsp;&nbsp;
   				<input type="button" value="入库查询"  id="searchInp"/>&nbsp;&nbsp;&nbsp;&nbsp;
   				<input type="button" value="出库查询"  id="searchOut"/>&nbsp;&nbsp;&nbsp;&nbsp;
   				<input id="product_add" type="button" value="新产品入库" />
   			</td>
    	</tr>
    	<tr>
   ...
   <div class="pagin">
        ...
        <li class="paginItem"><a href="/item/kucun_list?page=1">首页</a></li>
        <li class="paginItem"><a href="/item/kucun_list?page=${data.pageInfo.pageNo-1}"   <c:if test="${data.pageInfo.pageNo<=1}">  onclick="javascript:return false;" </c:if> >上一页</a></li>
        <li class="paginItem"><a href="/item/kucun_list?page=${data.pageInfo.pageNo+1}"   <c:if test="${data.pageInfo.pageNo>=data.pageInfo.totalPage}">  onclick="javascript:return false;" </c:if> >下一页</a></li>
        <li class="paginItem"><a href="/item/kucun_list?page=${data.pageInfo.totalPage}" >末页</a></li>
